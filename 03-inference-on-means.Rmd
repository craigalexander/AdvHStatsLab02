...
There are two conditions are required for making inference on numerical variables:
...
Next, we will be conducting a hypothesis test, and ultimately a confidence interval, for a **difference of two means**. Namely, the mean weights in the two groups (those that are active 3+ days a week and the other group that aren't).
